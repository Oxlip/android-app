...
public class BleScanActivity extends ListActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!mScanning) {
            menu.findItem(R.id.ble_scan_action_bar_stop).setVisible(false);
            menu.findItem(R.id.ble_scan_action_bar_scan).setVisible(true);
            menu.findItem(R.id.ble_scan_action_bar_refresh).setActionView(null);
        } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.ble_scan_action_bar_scan:
                mLeDeviceListAdapter.clear();
                scanLeDevice(true);
                break;
            case R.id.ble_scan_action_bar_stop:
                scanLeDevice(false);
                break;
        }
        return true;
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = mInflator.inflate(R.layout.ble_scan_listitem, null);
