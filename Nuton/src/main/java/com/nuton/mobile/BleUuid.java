...
public class BleUuid {
    ...
    public static final UUID HS_SERVICE = UUID.fromString("c0f41003-9324-4085-aba0-0902c0e8950a");
    public static final UUID LS_SERVICE = UUID.fromString("c0f41004-9324-4085-aba0-0902c0e8950a");
    public static final UUID MS_SERVICE = UUID.fromString("c0f41005-9324-4085-aba0-0902c0e8950a");
    ...
    public static final UUID HS_CHAR = UUID.fromString("c0f42003-9324-4085-aba0-0902c0e8950a");
    public static final UUID LS_CHAR = UUID.fromString("c0f42004-9324-4085-aba0-0902c0e8950a");
    public static final UUID MS_CHAR = UUID.fromString("c0f42005-9324-4085-aba0-0902c0e8950a");
